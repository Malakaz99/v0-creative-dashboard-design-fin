- dashboard: creative_performance_main
  title: "Isracard Creative Performance - Main Dashboard"
  layout: newspaper
  preferred_viewer: dashboards-next
  description: "Comprehensive creative performance analytics for Isracard digital campaigns"
  ...
  - title: "Platform Performance Comparison"
    name: platform_comparison_chart
    model: isracard_creative_analytics
    explore: creative_performance
    type: looker_column
